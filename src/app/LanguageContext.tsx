...
const translations = {
  ...
  ja: {
    ...
    'hero.title': '私の旅行の予算、\n1分で確認してください',
    'hero.subtitle': '宿泊からアクティビティまで、数回のクリックで完成する\n自分だけのカスタム旅行見積書',
    ...
    'why.point2.desc': '複数のホテルやツアーのオプションを比較し、予算にぴったりの旅行を作りましょう。',
    ...
    'footer.disclaimer': 'Trip Projectはユーザーの合理적인旅行計画を助けるために最善を尽くしています。\n表示される価格は参考用であり、実際の予約時点によって変動する場合があります。',
    ...
    'preview.footer_msg': '実際のカカオトークには、このような形式のカスタム見積書が送信されます。',
