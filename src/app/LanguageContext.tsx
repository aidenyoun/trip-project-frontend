...
const translations = {
  ko: {
    ...
    // Item Translations
    'item.hotel-5star-bkk.name': '5성급 럭셔리 호텔 (3박)',
    'item.hotel-5star-bkk.desc': '수영장 & 조식 포함',
    'item.hotel-3star-bkk.name': '3성급 호텔 (3박)',
    'item.hotel-3star-bkk.desc': '깔끔한 시설, 교통 편리',
    'item.night-tour-bkk.name': '방콕 나이트 투어',
    'item.night-tour-bkk.desc': '야시장 & 야경 크루즈',
    'item.floating-market-bkk.name': '수상시장 투어',
    'item.floating-market-bkk.desc': '보트 투어 & 현지 시장',
    'item.rooftop-bar-bkk.name': '루프탑 바 디너',
    'item.rooftop-bar-bkk.desc': '스카이 바 디너 코스',
    'item.thai-massage-bkk.name': '태국 전통 마사지 & 스파',
    'item.thai-massage-bkk.desc': '2시간 프리미엄 코스',
    'item.hotel-5star-dn.name': '5성급 비치 리조트 (3박)',
    'item.hotel-5star-dn.desc': '오션뷰 & 프라이빗 비치',
    'item.hotel-3star-dn.name': '3성급 호텔 (3박)',
    'item.hotel-3star-dn.desc': '깔끔한 시설, 해변 근처',
    'item.premium-van-dn.name': '16인승 프리미엄 밴',
    'item.premium-van-dn.desc': '럭셔리 차량, 에어컨 완비',
    'item.scooter-rental-dn.name': '스쿠터 렌탈 (3일)',
    'item.scooter-rental-dn.desc': '자유로운 이동, 헬멧 포함',
    'item.vip-fast-track-dn.name': 'VIP 패스트트랙',
    'item.vip-fast-track-dn.desc': '빠른 출입국 수속',
    'item.cable-car-dn.name': '바나힐 케이블카',
    'item.cable-car-dn.desc': '골든 브릿지 & 입장권',
    'item.yacht-tour-dn.name': '프라이빗 요트 투어',
    'item.yacht-tour-dn.desc': '4시간, 스노클링 포함',
  },
  en: {
    // BlogPost (Main)
    ...
    // Item Translations
    'item.hotel-5star-bkk.name': '5-Star Luxury Hotel (3 Nights)',
    'item.hotel-5star-bkk.desc': 'Pool & Breakfast included',
    'item.hotel-3star-bkk.name': '3-Star Hotel (3 Nights)',
    'item.hotel-3star-bkk.desc': 'Clean facility, Easy transport',
    'item.night-tour-bkk.name': 'Bangkok Night Tour',
    'item.night-tour-bkk.desc': 'Night market & Night cruise',
    'item.floating-market-bkk.name': 'Floating Market Tour',
    'item.floating-market-bkk.desc': 'Boat tour & Local market',
    'item.rooftop-bar-bkk.name': 'Rooftop Bar Dinner',
    'item.rooftop-bar-bkk.desc': 'Sky bar dinner course',
    'item.thai-massage-bkk.name': 'Thai Traditional Massage',
    'item.thai-massage-bkk.desc': '2 hours premium course',
    'item.hotel-5star-dn.name': '5-Star Beach Resort (3 Nights)',
    'item.hotel-5star-dn.desc': 'Ocean view & Private beach',
    'item.hotel-3star-dn.name': '3-Star Hotel (3 Nights)',
    'item.hotel-3star-dn.desc': 'Clean facility, Near beach',
    'item.premium-van-dn.name': '16-Seater Premium Van',
    'item.premium-van-dn.desc': 'Luxury vehicle, Full AC',
    'item.scooter-rental-dn.name': 'Scooter Rental (3 Days)',
    'item.scooter-rental-dn.desc': 'Free movement, Helmet included',
    'item.vip-fast-track-dn.name': 'VIP Fast Track',
    'item.vip-fast-track-dn.desc': 'Fast immigration service',
    'item.cable-car-dn.name': 'Bana Hills Cable Car',
    'item.cable-car-dn.desc': 'Golden Bridge & Entry ticket',
    'item.yacht-tour-dn.name': 'Private Yacht Tour',
    'item.yacht-tour-dn.desc': '4 hours, Snorkeling included',
  },
  ja: {
    // BlogPost (Main)
    ...
    // Item Translations
    'item.hotel-5star-bkk.name': '5つ星ラグジュアリーホテル (3泊)',
    'item.hotel-5star-bkk.desc': 'プール＆朝食付き',
    'item.hotel-3star-bkk.name': '3つ星ホテル (3泊)',
    'item.hotel-3star-bkk.desc': '清潔な施設、交通の便が良い',
    'item.night-tour-bkk.name': 'バンコクナイトツアー',
    'item.night-tour-bkk.desc': '夜市＆夜景クルーズ',
    'item.floating-market-bkk.name': '水上マーケットツアー',
    'item.floating-market-bkk.desc': 'ボートツアー＆ローカル市場',
    'item.rooftop-bar-bkk.name': 'ルーフトップバーディナー',
    'item.rooftop-bar-bkk.desc': 'スカイバーディナーコース',
    'item.thai-massage-bkk.name': 'タイ伝統マッサージ',
    'item.thai-massage-bkk.desc': '2時間プレミアムコース',
    'item.hotel-5star-dn.name': '5つ星ビーチリゾート (3泊)',
    'item.hotel-5star-dn.desc': 'オーシャンビュー＆プライベートビーチ',
    'item.hotel-3star-dn.name': '3つ星ホテル (3泊)',
    'item.hotel-3star-dn.desc': '清潔な施設、ビーチの近く',
    'item.premium-van-dn.name': '16人乗りプレミアムバン',
    'item.premium-van-dn.desc': '高級車両、エアコン完備',
    'item.scooter-rental-dn.name': 'スクーターレンタル (3日間)',
    'item.scooter-rental-dn.desc': '自由な移動、ヘルメット付き',
    'item.vip-fast-track-dn.name': 'VIPファ스트トラック',
    'item.vip-fast-track-dn.desc': '迅速な出入国審査',
    'item.cable-car-dn.name': 'バーナーヒルズケーブルカー',
    'item.cable-car-dn.desc': 'ゴールデンブリッジ＆入場券',
    'item.yacht-tour-dn.name': 'プライベートヨットツアー',
    'item.yacht-tour-dn.desc': '4時間、シュノーケリング付き',
  }
};
