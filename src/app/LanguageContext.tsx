...
const translations = {
  ko: {
    ...
    'calc.sort_field': '기준',
    'calc.sort_field_name': '이름',
    'calc.sort_field_price': '가격',
    'calc.sort_order': '순서',
    'calc.sort_order_asc': '오름차순',
    'calc.sort_order_desc': '내림차순',
  ...
  en: {
    ...
    'calc.sort_field': 'Sort by',
    'calc.sort_field_name': 'Name',
    'calc.sort_field_price': 'Price',
    'calc.sort_order': 'Order',
    'calc.sort_order_asc': 'Ascending',
    'calc.sort_order_desc': 'Descending',
  ...
  ja: {
    ...
    'calc.sort_field': '基準',
    'calc.sort_field_name': '名前',
    'calc.sort_field_price': '価格',
    'calc.sort_order': '順序',
    'calc.sort_order_asc': '昇順',
    'calc.sort_order_desc': '降順',
