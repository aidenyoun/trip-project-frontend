...
const TRAVEL_ITEMS: TravelItem[] = [
  ...
  },
  {
    ...
    price: 35000,
    image: "https://images.unsplash.com/photo-1510253406560-63664797099e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxKYXBhbiUyMHRyYWluJTIwcGFzc3xlbnwxfHx8fDE3NzMyOTM0NTV8MA&ixlib=rb-4.1.0&q=80&w=1080",
...
export function StepCalculator() {
  ...
  const handleCityChange = (cityId: string) => {
    ...
    setSelectedItems(new Set()); // Reset selections when city changes
        ...
        <div className="max-w-2xl mx-auto px-4 py-4">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div className="flex-1">
              <h1 className="text-xl">Travel Budget Calculator</h1>
              <p className="text-sm text-gray-500">Step-by-step planner</p>
            </div>
          </div>

          {/* City Selector */}
          <div className="mb-6">
            <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2 px-1">Choose Destination</p>
          ...
          {/* Sequential Progress Bar - Stepper */}
              ...
              return (
                <div key={step.id} className="flex items-center flex-1">
                  <div className="flex flex-col items-center flex-1">
                    <div 
                      className={`w-10 h-10 rounded-full flex items-center justify-center text-sm transition-all mb-2 ${
                        isActive 
                  ...
                  {index < STEPS.length - 1 && (
                    <div className="flex-shrink-0 w-8 mb-6">
                      <div className={`h-0.5 ${
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg z-10">
        <div className="max-w-2xl mx-auto px-4 py-5">
          ...
          <button
            onClick={handleNext}
            disabled={!canProceed}
            className={`w-full py-4 rounded-xl text-white text-base transition-all ${
              !canProceed
